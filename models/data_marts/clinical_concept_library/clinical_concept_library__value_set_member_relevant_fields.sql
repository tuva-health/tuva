...
from {{ ref('concept_library__clinical_concepts') }} as aa

left outer join {{ ref('concept_library__value_set_members') }} as bb
on aa.concept_id = bb.concept_id

left outer join {{ ref('concept_library__coding_systems') }} as cc
