...
inner join {{ ref('encounter_grouper__stg_medical_claim') }} as mc on mc.claim_id = ov.claim_id
    and mc.claim_line_number = ov.claim_line_number
inner join {{ ref('service_category_grouper__office_based_radiology') }} as scrad on mc.claim_id = scrad.claim_id
