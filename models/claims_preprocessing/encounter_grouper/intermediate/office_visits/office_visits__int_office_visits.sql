...
with anchor as (
    ...
    from {{ ref('encounter_grouper__stg_medical_claim') }} as mc
    inner join {{ ref('service_category_grouper__combined_professional') }} as p -- joining in all sc regardless of final priority
