...
select distinct
  elig.patient_id
  , elig.patient_id||coalesce(elig.data_source,'')||coalesce(elig.payer,'')||coalesce(elig.plan,'')||coalesce(elig.enrollment_start_date,'')||coalesce(elig.enrollment_end_date,'') as patient_id_key
