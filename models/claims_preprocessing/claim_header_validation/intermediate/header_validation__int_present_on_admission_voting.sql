...
with distinct_count as(
    ...
    from {{ ref('header_validation__int_present_on_admission_normalize') }}
    group by
        claim_id
        , data_source
        , diagnosis_column
...
select 
    ...
    , norm.normalized_present_on_admission_code
...
from {{ ref('header_validation__int_present_on_admission_normalize') }} norm
