...
with anchor as (
    ...
    from {{ ref('int_encounter__claim_line') }} as mc
    inner join {{ ref('int_service_category__combined_professional') }} as p -- joining in all sc regardless of final priority
