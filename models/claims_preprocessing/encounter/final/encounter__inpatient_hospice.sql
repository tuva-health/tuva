...
with detail_values as (
    ...
    inner join {{ ref('int_encounter__inpatient_hospice_start_end_date') }} as ed on cli.old_encounter_id = ed.encounter_id
)
...
from {{ ref('int_encounter__inpatient_hospice_start_end_date') }} as a
