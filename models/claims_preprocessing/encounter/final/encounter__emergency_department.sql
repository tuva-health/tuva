...
with detail_values as (
    ...
    inner join {{ ref('int_encounter__emergency_department_start_end_date') }} as ed on cli.old_encounter_id = ed.encounter_id
)
...
from {{ ref('int_encounter__emergency_department_start_end_date') }} as a
