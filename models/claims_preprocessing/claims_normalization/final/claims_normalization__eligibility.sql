...
left outer join {{ ref('claims_normalization__int_eligibility_dates_normalize') }} as date_norm
  on elig.person_id_key = date_norm.person_id_key
left outer join {{ ref('claims_normalization__int_eligibility_state_normalize') }} as ansi
