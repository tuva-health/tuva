with encounter_sk as (
    ...
    left join {{ ref('power_bi__dim_encounter_provider') }} p on e.encounter_id = p.encounter_id
...
INNER JOIN {{ ref('power_bi__dim_data_source') }} ds on mc.data_source = ds.data_source
