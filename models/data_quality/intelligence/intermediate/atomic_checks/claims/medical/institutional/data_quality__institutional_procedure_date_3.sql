...
SELECT DISTINCT -- to bring to claim_ID grain 
    ...
    ,CASE 
        ...
        WHEN M.Procedure_Date_3 > CURRENT_DATE() THEN 'invalid'
        WHEN M.Procedure_Date_3 < DATEADD(year, -10, CURRENT_DATE()) THEN 'invalid'
    ...
    ,CASE 
        WHEN CG.FREQUENCY > 1 THEN 'multiple'      
        WHEN M.Procedure_Date_3 > CURRENT_DATE() THEN 'future'
        WHEN M.Procedure_Date_3 < DATEADD(year, -10, CURRENT_DATE()) THEN 'too old'
