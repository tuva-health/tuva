...
SELECT
    ...
    ,case when M.DISCHARGE_DISPOSITION_CODE is not null then 'valid' else 'null' end as BUCKET_NAME
    ,null as INVALID_REASON
    ,CAST(DISCHARGE_DISPOSITION_CODE AS VARCHAR(255)) AS FIELD_VALUE
