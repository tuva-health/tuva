...
SELECT
    ...
    ,CASE 
        WHEN M.ENCOUNTER_END_DATE > '{{ var('tuva_last_run') }}' THEN 'invalid'
    ...
    END AS BUCKET_NAME
    ,CASE 
        WHEN M.ENCOUNTER_END_DATE > '{{ var('tuva_last_run') }}' THEN 'future'
    ...
    ,CAST(ENCOUNTER_END_DATE AS VARCHAR(255)) AS FIELD_VALUE
