...
select
    ...
    , 'APPOINTMENT_SPECIALTY' as field_name
    , case when appointment_specialty is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(appointment_specialty as {{ dbt.type_string() }}) as field_value
