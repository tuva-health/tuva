...
select
    ...
    , 'NORMALIZED_STATUS' as field_name
    , case when normalized_status is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(normalized_status as {{ dbt.type_string() }}) as field_value
