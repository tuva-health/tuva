...
select
    ...
    , 'SOURCE_APPOINTMENT_TYPE_CODE' as field_name
    , case when source_appointment_type_code is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_appointment_type_code as {{ dbt.type_string() }}) as field_value
