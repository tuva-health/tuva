...
select
    ...
    , 'CANCELLATION_REASON' as field_name
    , case when cancellation_reason is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(cancellation_reason as {{ dbt.type_string() }}) as field_value
