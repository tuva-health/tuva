...
select
    ...
    , 'SOURCE_STATUS' as field_name
    , case when source_status is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_status as {{ dbt.type_string() }}) as field_value
