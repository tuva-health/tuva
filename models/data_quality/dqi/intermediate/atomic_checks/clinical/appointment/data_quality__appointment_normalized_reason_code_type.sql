...
select
    ...
    , 'NORMALIZED_REASON_CODE_TYPE' as field_name
    , case when normalized_reason_code_type is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(normalized_reason_code_type as {{ dbt.type_string() }}) as field_value
