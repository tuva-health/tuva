...
select
    ...
    , 'SOURCE_REASON_DESCRIPTION' as field_name
    , case when source_reason_description is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_reason_description as {{ dbt.type_string() }}) as field_value
