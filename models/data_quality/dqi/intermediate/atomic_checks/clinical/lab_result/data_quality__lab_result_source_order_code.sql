...
select
    ...
    , 'SOURCE_ORDER_CODE' as field_name
    , case when m.source_order_code is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_order_code as {{ dbt.type_string() }}) as field_value
