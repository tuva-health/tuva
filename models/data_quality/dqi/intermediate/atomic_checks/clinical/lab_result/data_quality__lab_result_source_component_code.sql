...
select
    ...
    , 'SOURCE_COMPONENT_CODE' as field_name
    , case when m.source_component_code is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_component_code as {{ dbt.type_string() }}) as field_value
