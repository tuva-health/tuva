...
select
    ...
    , 'SOURCE_DOSE' as field_name
    , case when m.source_dose is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(source_dose as {{ dbt.type_string() }}) as field_value
