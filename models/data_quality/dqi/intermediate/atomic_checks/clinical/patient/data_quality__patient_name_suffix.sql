...
select
    ...
    , 'NAME_SUFFIX' as field_name
    , case when m.name_suffix is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(name_suffix as {{ dbt.type_string() }}) as field_value
