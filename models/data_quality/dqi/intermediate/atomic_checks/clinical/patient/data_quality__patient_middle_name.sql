...
select
    ...
    , 'MIDDLE_NAME' as field_name
    , case when m.middle_name is not null then 'valid' else 'null' end as bucket_name
    , cast(null as {{ dbt.type_string() }}) as invalid_reason
    , cast(middle_name as {{ dbt.type_string() }}) as field_value
