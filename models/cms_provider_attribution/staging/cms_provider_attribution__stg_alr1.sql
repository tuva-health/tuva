...
select retro.*, 'retrospective' as assignment_methodology from {{ref('input_layer__alr1_retrospective')}} retro

{% elif var('assignment_methodology') == 'prospective' %}

select prosp.*, 'prospective' as assignment_methodology from {{ref('input_layer__alr1_prospective')}} prosp
