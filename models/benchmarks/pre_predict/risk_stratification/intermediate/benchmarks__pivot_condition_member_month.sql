...
/* Returns person member-month grain. Did the patient have the condition coded in the month? */
with cte as (
    select distinct
        a.person_id
...
, year_month as condition_year_month
...
, f.condition_year_month as year_month
