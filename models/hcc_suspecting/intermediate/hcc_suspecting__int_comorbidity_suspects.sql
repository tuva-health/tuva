...
, hcc_37_suspect as (
    ...
    select
          ckd_stage_1_or_2_dedupe.patient_id
        , ckd_stage_1_or_2_dedupe.data_source
        , '37' as hcc_code
    ...
    from ckd_stage_1_or_2_dedupe
        inner join diabetes_dedupe
            on ckd_stage_1_or_2_dedupe.patient_id = diabetes_dedupe.patient_id
