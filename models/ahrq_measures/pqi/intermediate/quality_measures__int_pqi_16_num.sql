with diagnosis as (
    ...
    inner join quality_measures._value_set_pqi as pqi
...
inner join {{ ref('quality_measures__int_pqi_16_denom') }} as denom 
...
left join {{ ref('quality_measures__int_pqi_16_exclusions') }} as shared
