...
with combine as (
  ...
  left outer join {{ ref('int_core__cost_service_category_1_paid_pivot') }} as b
  ...
  left outer join {{ ref('int_core__cost_service_category_2_paid_pivot') }} as c
  ...
  left outer join {{ ref('int_core__cost_service_category_1_allowed_pivot') }} as d
  ...
  left outer join {{ ref('int_core__cost_service_category_2_allowed_pivot') }} as e
