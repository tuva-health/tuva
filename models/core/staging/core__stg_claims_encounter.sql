...
from {{ ref('acute_inpatient__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('emergency_department__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('inpatient_hospice__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('inpatient_psych__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('inpatient_rehab__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('inpatient_snf__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('inpatient_substance_use__encounter_grain') }} 
...
select
    ...
    , cast(encounter_type as {{ dbt.type_string() }} ) as encounter_type
    , {{ try_to_cast_date('encounter_start_date', 'YYYY-MM-DD') }} as encounter_start_date
    , {{ try_to_cast_date('encounter_start_date', 'YYYY-MM-DD') }} as encounter_end_date
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('urgent_care__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('office_visit__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_hospice__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_hospital_or_clinic__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_injections__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_psych__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_ptotst__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_radiology__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_rehab__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('outpatient_substance_use__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('home_health__encounter_grain') }} 
...
select
    ...
    , cast(prof_claim_count as  {{ dbt.type_int() }}) as prof_claim_count
    , cast('{{ var('tuva_last_run')}}' as {{ dbt.type_timestamp() }} ) as  tuva_last_run
from {{ ref('dialysis__encounter_grain') }} 
