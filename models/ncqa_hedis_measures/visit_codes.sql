...
select distinct claim_id, person_id
...
on aa.claim_id = bb.claim_id and aa.person_id = bb.person_id
),
...
left join claims_with_pos_81 bb
on aa.person_id = bb.person_id and aa.claim_id = bb.claim_id

left join claims_admission_and_discharge_dates cc
on aa.person_id = cc.person_id and aa.claim_id = cc.claim_id

where (aa.normalized_code is not null and aa.normalized_code_type is not null)
),
