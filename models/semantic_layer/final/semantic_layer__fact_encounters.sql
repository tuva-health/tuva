...
select
  ...
  , {{ dbt.concat(["person_id", "'|'", the_tuva_project.to_char('encounter_start_date', 'YYYYMM')]) }} as member_month_sk
  , {{ the_tuva_project.to_char('encounter_start_date', 'YYYYMM') }} as year_month
