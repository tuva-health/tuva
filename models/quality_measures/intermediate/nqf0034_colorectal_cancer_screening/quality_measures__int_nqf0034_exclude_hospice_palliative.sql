...
with exclusion_codes as (
    ...
    select
          'G9710' as code
        , '	Patient was provided hospice services any time during the measurement period' as descriptor
        , 'hcpcs' as code_system
        , 'nqf past history' as valuesetname
    union all
    select
          'G9711' as code
        , 'Patient was provided palliative care services any time during the measurement period' as descriptor
        , 'hcpcs' as code_system
        , 'nqf past history' as valuesetname
