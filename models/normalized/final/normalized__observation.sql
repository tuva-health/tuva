...
{%- set tuva_extension_columns -%}
    {{ select_extension_columns(ref('stg_input_layer__observation'), strip_prefix=false) }}
{%- endset %}
...
with obs as (
    ...
    from {{ ref('stg_input_layer__observation') }}
...
select
    ...
    {{ select_extension_columns(ref('stg_input_layer__observation'), alias='obs', strip_prefix=false) }}
    , obs.tuva_last_run
    , obs.data_source
from obs
