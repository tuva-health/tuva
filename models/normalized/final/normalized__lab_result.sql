...
{%- set tuva_extension_columns -%}
    {{ select_extension_columns(ref('stg_input_layer__lab_result'), strip_prefix=false) }}
{%- endset %}
...
with labs as (
    ...
    from {{ ref('stg_input_layer__lab_result') }}
...
select
    ...
    {{ select_extension_columns(ref('stg_input_layer__lab_result'), alias='labs', strip_prefix=false) }}
    , labs.tuva_last_run
    , labs.data_source
from labs
