...
with immune as (
    ...
    select
        {{ tuva_core_columns }}
        {{ select_extension_columns(ref('stg_input_layer__immunization'), strip_prefix=false) }}
        {{ tuva_metadata_columns }}
    from {{ ref('stg_input_layer__immunization') }}
...
select
    ...
    {{ select_extension_columns(ref('stg_input_layer__immunization'), alias='immune', strip_prefix=false) }}
