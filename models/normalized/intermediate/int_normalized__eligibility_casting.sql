...
select
    ...
    , cast(elig.sex as {{ dbt.type_string() }}) as sex
    ...
    {{ select_extension_columns(ref('stg_input_layer__eligibility'), alias='elig', strip_prefix=false) }}
...
from {{ ref('stg_input_layer__eligibility') }} as elig
