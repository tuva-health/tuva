const LINEAGE_API_URL = "./api/lineage";
const REFRESH_API_URL = "./api/refresh";
const EVENTS_API_URL = "./api/events";
const SEED_PREVIEW_API_URL = "./api/seed-preview";
const SAVE_NODE_API_URL = "./api/save-node";
const LOGO_URL = "./docs-static/img/the_tuva_project_logo_new.png";
  ...
  app.innerHTML = `
    <div class="status-page">
      <div class="status-card">
        <img class="status-logo" src="${LOGO_URL}" alt="The Tuva Project" />
        <h1>${escapeHtml(refresh.status === "refreshing" ? "Refreshing DAG" : "Waiting for DAG data")}</h1>
...
function canEditNode(node) {
  return Boolean(node) && !isDagBoundaryNode(node);
}
