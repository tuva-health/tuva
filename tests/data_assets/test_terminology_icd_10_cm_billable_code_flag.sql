...
select
    invalid_flags.icd_10_cm
    , invalid_flags.billable_code_flag
    , invalid_flags.failure_reason
from invalid_flags

union all

select
    anchor_failures.icd_10_cm
    , anchor_failures.billable_code_flag
    , anchor_failures.failure_reason
