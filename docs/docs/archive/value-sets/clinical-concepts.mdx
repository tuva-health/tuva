...
<JsonDataTable  jsonPath="nodes.seed\.the_tuva_project\.concept_library__clinical_concepts.columns" />
...
<JsonDataTable  jsonPath="nodes.seed\.the_tuva_project\.concept_library__value_set_members.columns" />
...
<JsonDataTable  jsonPath="nodes.seed\.the_tuva_project\.concept_library__coding_systems.columns" />
